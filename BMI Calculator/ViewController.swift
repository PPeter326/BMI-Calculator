...
class ViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    var userInput: UserInput? {
        get {
            return UserInput(weightInLbs: weightInLbs, heightInInches: totalHeightInInches)
        }
        set {
            weightInLbs = newValue!.weightInLbs
            totalHeightInInches = newValue!.totalHeightInInches
            weightInKgs = newValue!.weightInKg
            totalHeightCentimeters = newValue!.totalHeightInCentimeters
        }
    }
...
//            }
    ...
    func saveUserInput() {
        ...
        userInput = UserInput(weightInLbs: weightInLbs, heightInInches: totalHeightInInches)
